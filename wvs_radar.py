...
app.layout = html.Div([
    ...
    html.Div(
        [html.Div([*[html.Div(children=[
            ...
            html.P('Source: ', style={'display':'inline-block', 'font-size': '10px', 'color':'#9e9e9e'}),dcc.Link("World Value Survey Wave 7", href="https://www.worldvaluessurvey.org/WVSDocumentationWV7.jsp", style={'display':'inline-block', 'color':'#e19899', 'font-size': '10px'})],
